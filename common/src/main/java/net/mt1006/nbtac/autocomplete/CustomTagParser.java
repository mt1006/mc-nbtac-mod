...
import net.mt1006.nbtac.autocomplete.type.complex.TagsType;
...
public class CustomTagParser
{
	private static final NbtSuggestion TEXT_COMPONENT_DUMMY =
			new NbtSuggestion("nbtac:text_component_dummy", TextComponentType.INSTANCE);
	private static final NbtSuggestion TEXT_STYLE_DUMMY =
			new NbtSuggestion("nbtac:text_style_dummy", new TagsType("text/nbtac:style", false));
	...
	{
		net.mt1006.nbtac.autocomplete.type.Type expectedType = suggestion != null
