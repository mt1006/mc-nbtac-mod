...
public class FabricResourceLoader implements SimpleResourceReloadListener<Map<Identifier, JsonElement>>
{
	...
	@Override public CompletableFuture<Map<Identifier, JsonElement>> load(ResourceManager manager, Executor executor)
	{
		return CompletableFuture.supplyAsync(() -> loader.prepare(manager));
	}

	@Override public CompletableFuture<Void> apply(@NotNull Map<Identifier, JsonElement> resources,
